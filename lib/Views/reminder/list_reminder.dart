...
class ListReminder extends StatelessWidget {
  const ListReminder({super.key, required this.reminders, required this.onRemoveReminder});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(itemCount: reminders.length, itemBuilder: (context, index) {
      return Dismissible(
