...
class BulletAnswer extends StatelessWidget {
  const BulletAnswer(
      {super.key,
      required this.prompt,
      required this.generativeGeminiBulletAnswer,
      required this.isKeyword});

  final String prompt;
  final Future<String> Function(String prompt) generativeGeminiBulletAnswer;
  final bool Function(String line, List<String> keywords) isKeyword;

  void _continueElaborate(BuildContext context, List<String> responses) {
    ...
    return Column(
      children: [
        FutureBuilder<String>(
          future: generativeGeminiBulletAnswer(prompt),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            _continueElaborate(context, responses);
                          },
                          child: const Text(
                            'Continue',
                            style: TextStyle(
